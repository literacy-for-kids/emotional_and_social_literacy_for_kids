...
| **Materials** | Telemetry Log, a timer, a quiet space, optional: a comfortable surface to lie down on |
| **Key vocabulary** | box breathing, somatic grounding, progressive muscle relaxation, regulation firmware |
| **Difficulty** | Moderate |
...
> Name 3 things you can TOUCH (and touch them).
