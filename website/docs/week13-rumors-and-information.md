...
"When people pass stories around, the story can change. Before you pass something on, stop and check."
:::
...
- [Guided Session 1: How Stories Change](#guided-session-1)
- [Guided Session 2: Check Before You Tell](#guided-session-2)
...
1. **Do I know it is true?**
2. **Is it kind?**
3. **Does it need to be shared?**
...
1. **Describe what happens:** "What happens when stories travel?" (Looking for: they can change, lose details, and pick up drama.)
2. **Name the three questions:** "What are the three check-before-you-tell questions?"
3. **Apply the check:** Give a hypothetical and ask how they would decide.
...
- Use the **Check Before You Tell Card** in [Student Tools and Printables](/docs/student-tools-and-printables) for screenshot, forwarding, and permission decisions.
