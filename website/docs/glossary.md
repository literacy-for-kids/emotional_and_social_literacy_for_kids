...
| **Boundary** | A clear, explicit rule for how you want to be treated in a relationship — an "interface specification" for the human system. | Week 10 |
...
| **Catastrophizing** | Treating a small problem as if it were a disaster — taking a setback and turning it into the end of the world. | Week 5 |
| **Check** | The third part of a protocol — how you'll know if it's working. A specific, observable measure. | Week 16 |
...
| **Default response** | The pre-decided action you take when your protocol's trigger fires. Designed in advance so you don't have to figure it out in the hot moment. | Week 16 |
| **Degraded mode** | What happens when your processing capacity is low — small things feel bigger, reactions get faster, the system runs poorly. Not a character flaw. | Week 2 |
| **Deployment** | The week you take your protocol into the real world and run it for real. The phase where the design meets reality. | Week 17 |
...
| **Feedback loop** | A system where the output becomes the next input, amplifying itself. Catastrophic thinking is a feedback loop: worry → fear → worse worry → bigger fear. | Week 7 |
...
| **Friction point** | A specific, recurring problem in your social or emotional life — something that keeps happening and that you keep struggling with. | Week 15 |
...
| **Hidden constraint** | A rule or condition affecting someone's behavior that you don't know about. Most conflict is caused by hidden constraints, not by anyone being bad. | Week 14 |
...
| **Mutual support** | When members of a network reliably help each other — the strategy that produces the best long-run results in iterated games. | Week 14 |
...
| **Pre-mortem** | Imagining that your protocol failed and asking why — before deployment. Lets you patch weaknesses while you're still in design mode. | Week 16 |
...
| **Processing capacity** | How much your brain can handle at any given moment. Changes constantly based on sleep, food, sensory load, and emotional weight. | Week 2 |
...
| **Protocol** | An explicit, pre-decided plan for how to handle a specific recurring situation. A gift from calm-you to hot-you. | Week 16 |
| **Rational response protocol** | The deliberate response chosen at the end of an Input/Output Audit — what you actually do, picked from at least three options, not just the first reaction. | Week 8 |
| **Reactive mode** | The brain's emergency-override state, run by the amygdala. Fast, defensive, narrow — built for survival, not for nuance. | Week 3 |
...
| **Root cause** | The underlying reason a problem keeps happening — not just the surface symptom. Found via tools like the 5 Whys. | Week 15 |
