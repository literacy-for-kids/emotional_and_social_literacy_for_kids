...
"Sometimes your brain tells a story that feels true but might not be true. Those are thought bugs."
:::
...
- [Guided Session 1: Meet the Thought Bugs](#guided-session-1)
- [Guided Session 2: Thought Bug Hunt](#guided-session-2)
...
| **Key vocabulary** | thought bug, cognitive distortion, disaster brain, guessing what they think, always/never brain |
| **Difficulty** | Moderate |
...
| Kid Name | Toolbox Name | Example |
|---|---|---|
| **Disaster Brain** | catastrophizing | "I forgot one homework page. My whole week is ruined." |
| **Guessing What They Think** | mind-reading | "He did not wave at recess. He must hate me." |
| **Making It About Me** | personalization | "Mom looks stressed. It must be because of me." |
| **Always/Never Brain** | all-or-nothing thinking | "I messed up once. I always ruin everything." |
