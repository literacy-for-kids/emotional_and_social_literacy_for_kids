...
const sidebars = {
  curriculumSidebar: [
    ...
    },
    {
      ...
      description: 'Companion module: grab-and-go tools for real moments',
      collapsed: false,
      link: {type: 'doc', id: 'coping-skills/intro'},
      items: [
        'coping-skills/intro',
        'coping-skills/lesson-01-system-signals',
        'coping-skills/lesson-02-pause-button',
        'coping-skills/lesson-03-grounding',
        'coping-skills/lesson-04-breathing',
        'coping-skills/lesson-05-body-reset',
