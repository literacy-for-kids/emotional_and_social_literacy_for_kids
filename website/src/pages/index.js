    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className={clsx('container', styles.heroContent)}>
        <div className={styles.heroCopy}>
          ...
          <h1 className="hero__title">Emotional &amp; Social Literacy for Kids</h1>
          ...
          <div className={styles.buttons}>
            ...
            <Link
              ...
              to="https://github.com/literacy-for-kids/emotional_and_social_literacy_for_kids">
              View on GitHub
            </Link>
          </div>
        </div>
...
export default function Home() {
  return (
    <Layout
      title="Welcome"
      description="A free, open 18-week curriculum that teaches ages 8–12 how emotions and social systems actually work.">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
      </main>
